...
class _AdminCreateAgreementScreenState
  ...
  final _propertyOwnerNameFallback = TextEditingController();
  final _propertyAddressFallback = TextEditingController();
    ...
    return Scaffold(
      ...
      body: propertiesAsync.when(
        data: (properties) => customersAsync.when(
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              const SizedBox(width: 8),
                              OutlinedButton.icon(
                                icon: Icon(Icons.person_add, color: AppTheme.terracotta, size: 18),
                            ...
                            children: [
                              Expanded(
                                child: ListTile(
                                  ...
                                  trailing: Icon(Icons.calendar_today, size: 18, color: AppTheme.terracotta),
                                  onTap: () async {
          ...
          loading: () => Center(child: CircularProgressIndicator(color: AppTheme.terracotta)),
        ...
        children: [
          TextField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: Icon(Icons.search, color: AppTheme.terracotta, size: 20),
            ...
            Container(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, i) {
                  ...
                  return ListTile(
                    dense: true,
                    leading: Icon(Icons.person_outline, color: AppTheme.terracotta),
